...
// load firebase
var config = {
        apiKey: "AIzaSyCjmkWHMBcgaQkfg9a9ne0fhFIEuRXz3y8",
        authDomain: "michaelpiecebroker.firebaseapp.com",
        databaseURL: "https://michaelpiecebroker.firebaseio.com",
        projectId: "michaelpiecebroker",
        storageBucket: "michaelpiecebroker.appspot.com",
        messagingSenderId: "202140698001"
};
...
database.ref().once("value", function(snapshot) {
    var sv = snapshot.val();
    //set value of apiKey
    apiKey = "1fdfae551270f55dd3f46687e5ebc927";
    googleApiKey = "AIzaSyDmGA7r6d8bf5fqCFqppNB6HE_Wxs7yjUs";
    mapQuestApiKey = "bJpj6j9R0bk5XakQF8siRSsFeGa8mB92";
});
window.onload = function() {
    ...
    if (localStorage.getItem('latitude') !== null || localStorage.getItem('longitude') !== null) {
        ...
        `https://www.mapquestapi.com/geocoding/v1/reverse?key=bJpj6j9R0bk5XakQF8siRSsFeGa8mB92&location=${userLatitude}%2C${userLongitude}&outFormat=json&thumbMaps=false`;
        ...
        var geoSuccess = function(position) {
            ...
            //Map Quest Reverse Geocoding API to get user Location
            var mapQuestUrl = `https://www.mapquestapi.com/geocoding/v1/reverse?key=bJpj6j9R0bk5XakQF8siRSsFeGa8mB92&location=${userLatitude}%2C${userLongitude}&outFormat=json&thumbMaps=false`;
            console.log(mapQuestUrl);
            $.ajax({
                url: mapQuestUrl,
                method: 'GET'
...
$('#submitBtn').on('click', function(e) {
    ...
    // Get Zomato Data and store cityID in a variable
        ...
        $.ajax({
            ...
            method: 'GET',
            headers: {
                'user-key': "1fdfae551270f55dd3f46687e5ebc927"
            }
        }).done(function(response) {
            $('.loader').hide();
...
$('#hungryBtn').on('click', function(e) {
    ...
    //Get Zomato data for random restaurants
        ...
        $.ajax({
            ...
            //replaced
            var searchURL = 
                            `https://developers.zomato.com/api/v2.1/search?entity_id=${cityID}&entity_type=city&count=20&cuisines=${cuisineID}`
            ;
            $.ajax({
                url: searchURL,
                method: 'GET',
